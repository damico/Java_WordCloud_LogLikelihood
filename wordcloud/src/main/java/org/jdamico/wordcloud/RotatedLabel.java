...
public class RotatedLabel extends JLabel {
	...
	{
		// it's better to set this here as default for all constructors since
		// they
	...
	/**
	 * A flag indicating whether {link #getSize()} and such methods need to
	 * return a rotated dimension.
	 */
	private boolean needsRotate;

	/**
	 * Initialises a new instance of the {@link RotatedLabel} class using
	 * default values.
	 */
	public RotatedLabel() {
		super();
	...
	protected void paintComponent(Graphics g) {
		...
		case VERTICAL_DOWN:
			gr.transform(AffineTransform.getQuadrantRotateInstance(1));
			gr.translate(1, -getSize().getWidth());
			break;
		default:
		}
